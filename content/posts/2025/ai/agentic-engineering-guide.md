# Guia Prático de Engenharia Agêntica: Stack de Skills, MCP e Contexto de Projeto
...
![Progressive Disclosure](image-1.png)
...
## 7. Recursos e Referências (Links Úteis)
...
*   *"Building Effective Agents"* (Anthropic Engineering): [anthropic.com/engineering/building-effective-agents](https://www.anthropic.com/engineering/building-effective-agents) - Padrões práticos para projetar agentes robustos.
*   *"ReAct: Synergizing Reasoning and Acting in Language Models"*: [arxiv.org/abs/2210.03629](https://arxiv.org/abs/2210.03629) - Base conceitual para o loop raciocínio + ação.
*   *"Toolformer: Language Models Can Teach Themselves to Use Tools"*: [arxiv.org/abs/2302.04761](https://arxiv.org/abs/2302.04761) - Uso de ferramentas externas por LLMs.
*   *"Lost in the Middle: How Language Models Use Long Contexts"*: [arxiv.org/abs/2307.03172](https://arxiv.org/abs/2307.03172) - Limites práticos de contexto longo e posicionamento de informação.

**Repositórios de Exemplo (Conceituais):**
*   `awesome-mcp-servers`: [github.com/punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) para ver implementações reais de servidores MCP.
*   Exemplos de "Agentic Workflows": [LangChain](https://github.com/langchain-ai/langchain) e [AutoGen](https://github.com/microsoft/autogen), que implementam conceitos similares de Skills/Tools.
